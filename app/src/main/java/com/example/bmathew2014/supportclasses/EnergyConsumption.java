...
public class EnergyConsumption implements Command {
    ...
    @Override
    public void execute() {
        int consumption =   coolingSystem.getEnergyConsumption()+fireAlarm.getEnergyConsumption()+
        ...
        System.out.println("Total energy consumption used by all applicances:"+consumption);
    }
}
